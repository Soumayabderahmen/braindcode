  ...
  <div class="card-body">
      ...
      <div class="flex flex-col gap-4 mt-4">
        <div class="flex items-center px-6 py-3 font-semibold text-sm" style=" border-radius: 12px;">
          ...
          <div class="w-1/6 text-center" style="color: #005183;"><b>Startup</b></div>
          <div class="w-1/6 text-center" style="color: #005183;"><b>Coach</b></div>
          <div class="w-1/6 text-center" style="color: #005183;"><b>Statut</b></div>
          <div class="w-1/6 text-center" style="color: #005183;"><b>Heure de réunion</b></div>
          <div class="w-1/6 text-center" style="color: #005183;"><b>Durée</b></div>
          <div class="w-1/6 text-center" style="color: #005183;"><b>Date de Création</b></div>
        </div>
...
">
          ...
          <div
            ...
            {{ reservation.startup?.user.name.charAt(0).toUpperCase() }}
          </div>

          <div class="w-28 text-center text-sm " style="
    color: #0093EE;
">
            {{ reservation.startup?.user.name }}
          </div>
          <div class="w-28 text-center text-sm " style="
    color: #0093EE;
">
