...
<template>
    <Main :showSidebar="true">
        <div class="p-6 bg-white shadow rounded-lg" style="width: 79vw; margin-left: 7px;">
            <h1 class="text-2xl font-bold mb-4 text-center">Liste de Mes Réservations</h1>
          ...
          class=" bg-blue-600 hover:bg-blue-700 transition duration-300 text-white font-semibold px-6 py-2 rounded-full shadow-md"
        >
        ➕ Réserver un nouveau Coach
        </a>
            </div>
                ...
                <table class="min-w-full bg-white border border-gray-300 rounded-lg shadow">
                    <thead class="bg-gray-200 text-gray-600 text-center border-t">
                        <tr>
                            ...
                            <th class="py-2 px-4 border">Nom du Mon Startup</th>
                        ...
                        <tr v-for="reservation in filteredReservations" :key="reservation.id"
                            ...
                            <td class="py-2 px-4">
                                <span v-if="reservation.statut === 'en attente'"   style="background-color: darkgray; padding: 5px 10px; border-radius: 50px; color: white;">
                                    En
                                    attente</span>
                                <span v-else-if="reservation.statut === 'accepter'"
                                    class="label label-success">Acceptée</span>
